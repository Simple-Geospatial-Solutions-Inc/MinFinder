document.addEventListener("DOMContentLoaded", function(event) {
    ...
    function showPosition(position) {
        ...
        window.addEventListener('deviceorientation', function(eventData2) {
            ...
            var rot = dir + brg;
            // rotate the arrow on the screen to point towards the destination
    ...
    function geoError() {
        ...
        document.getElementById("bearing").innerHTML = "Not available";
        document.getElementById("latitude").innerHTML = "Not available";
        document.getElementById("longitude").innerHTML = "Not available";
        document.getElementById("accuracy").innerHTML = "Not available";  
    }
